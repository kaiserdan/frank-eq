...
LAPACK backends cannot alter plan identity; signed zero is normalized in that
digest. Runtime arrays remain float64. Any change requires review and a new
clean commit before model access.
